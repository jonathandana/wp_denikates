...
<form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none">
    ...
    <p class="form-row form-row-last">
        <button type="submit" class="button woo-btn-denikates" name="apply_coupon" value="<?php esc_attr_e( 'הזן קופון', 'woocommerce' ); ?>"><?php esc_html_e( 'הזן קופון', 'woocommerce' ); ?></button>
    </p>
